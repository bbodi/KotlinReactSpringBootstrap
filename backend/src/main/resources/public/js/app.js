(function (Kotlin) {
  ...
  var _ = Kotlin.defineRootPackage(function () {
    ...
    hu: Kotlin.definePackage(null, /** @lends _.hu */ {
      nevermind: Kotlin.definePackage(null, /** @lends _.hu.nevermind */ {
        reakt: Kotlin.definePackage(null, /** @lends _.hu.nevermind.reakt */ {
          AjaxRequest: Kotlin.createClass(null, function (url, type, data, contentType, dataType, async, success) {
          ...
          }, /** @lends _.hu.nevermind.reakt.AjaxRequest.prototype */ {
            component1: function () {
              return this.url;
            },
            component2: function () {
            ...
            copy_975uij$: function (url, type, data, contentType, dataType, async, success) {
              return new _.hu.nevermind.reakt.AjaxRequest(url === void 0 ? this.url : url, type === void 0 ? this.type : type, data === void 0 ? this.data : data, contentType === void 0 ? this.contentType : contentType, dataType === void 0 ? this.dataType : dataType, async === void 0 ? this.async : async, success === void 0 ? this.success : success);
            },
            toString: function () {
          ...
          AjaxResult: Kotlin.createClass(null, function (status, data) {
            this.status = status;
            this.data = data;
          }, /** @lends _.hu.nevermind.reakt.AjaxResult.prototype */ {
            component1: function () {
              return this.status;
            },
            component2: function () {
            ...
            copy_eltq40$: function (status, data) {
              return new _.hu.nevermind.reakt.AjaxResult(status === void 0 ? this.status : status, data === void 0 ? this.data : data);
            },
            toString: function () {
          ...
          ajaxPost_p8t2dm$: function (ajaxRequest) {
            $.ajax(ajaxRequest);
          },
          ...
          bootstrap: Kotlin.definePackage(function () {
            ...
            onTheFly_i41a89$f: function (it) {
              return 0;
            },
            onTheFly_i41a89$: function (init) {
              var $receiver = new _.com.github.andrewoma.react.Component(_.hu.nevermind.reakt.bootstrap.onTheFly_i41a89$f);
              init.call($receiver);
            ...
            }, /** @lends _.hu.nevermind.reakt.bootstrap.InputProperties.prototype */ {
              type: {
                get: function () {
                  return this.type$delegate.getValue_dsk1ci$(this, new Kotlin.PropertyMetadata('type'));
                },
            ...
            bsInput_nlwo8j$f: function () {
            },
            bsInput_nlwo8j$f_0: function () {
            },
            bsInput_nlwo8j$: function ($receiver, properties, init) {
              if (properties === void 0)
                properties = _.hu.nevermind.reakt.bootstrap.bsInput_nlwo8j$f;
              if (init === void 0)
                init = _.hu.nevermind.reakt.bootstrap.bsInput_nlwo8j$f_0;
              _.hu.nevermind.reakt.bootstrap.externalReactClassWithoutChild_fx8i9d$($receiver, ReactBootstrap.Input, new _.hu.nevermind.reakt.bootstrap.InputProperties(), properties, init);
            }
          })
        }),
        app: Kotlin.definePackage(function () {
          ...
          this.RouterStore = Kotlin.createObject(function () {
            ...
            $fun.baseInitializer.call(this);
            this.$path_hv4dqx$ = '';
            this.hashChangeEventListenerActive_syi2n6$ = true;
            ...
            match_eoa9s7$: function (patterns) {
              var predicate = _.hu.nevermind.app.match_eoa9s7$f(this);
              var tmp$0, tmp$1, tmp$2;
          ...
          main_kand9s$f: function (it) {
            _.hu.nevermind.app.config.Actions.setConfigs.invoke_3vhket$(_.hu.nevermind.app.globalDispatcher, it);
          },
          main_kand9s$: function (arg) {
            ...
            if (Kotlin.modules['stdlib'].kotlin.text.contains_kzp0od$(window.location.search, 'tests')) {
              ...
              $('#qunit').hide();
              $('#qunit-fixture').hide();
              _.hu.nevermind.app.getConfigsFromServer_stx1lv$(_.hu.nevermind.app.main_kand9s$f);
            }
          },
          AppScreen: Kotlin.createEnumClass(function () {
            ...
            return {
              Main: new _.hu.nevermind.app.AppScreen(),
          ...
          App: Kotlin.createClass(function () {
            ...
            initialState: function () {
              return new _.hu.nevermind.app.AppState(_.hu.nevermind.app.AppScreen.object.Main);
            },
            ...
            f: function (this$App) {
              return function (params) {
                ...
                _.hu.nevermind.app.config.Actions.setEditingKeyValue.invoke_3vhket$(_.hu.nevermind.app.globalDispatcher, params.get_za3rmp$('editedConfId'));
              };
            },
            f_0: function (this$App) {
              return function (params) {
                this$App.state = new _.hu.nevermind.app.AppState(_.hu.nevermind.app.AppScreen.object.Main);
              };
            },
            componentDidMount$f: function (this$App) {
              return function () {
                _.hu.nevermind.app.RouterStore.match_eoa9s7$([Kotlin.modules['stdlib'].kotlin.to_l1ob02$('config/?editedConfId', _.hu.nevermind.app.App.f(this$App)), Kotlin.modules['stdlib'].kotlin.to_l1ob02$('', _.hu.nevermind.app.App.f_0(this$App))]);
              };
            },
            ...
            f_3: function () {
              _.com.github.andrewoma.react.a_z74dev$(this, _.hu.nevermind.app.App.f_1, _.hu.nevermind.app.App.f_2);
            },
            f_4: function () {
              _.hu.nevermind.reakt.bootstrap.bsNavbarBrand_xt4fwq$(this, void 0, _.hu.nevermind.app.App.f_3);
            },
            f_5: function (this$App) {
              return function () {
                this.id = 'configScreenNavItem';
                this.href = _.Path.config.root;
            ...
            f_14: function () {
              ...
              _.hu.nevermind.reakt.bootstrap.bsMenuItem_r2i6fj$(this, void 0, _.hu.nevermind.app.App.f_12);
              _.hu.nevermind.reakt.bootstrap.bsMenuItemDivider_r2i6fj$(this);
              _.hu.nevermind.reakt.bootstrap.bsMenuItem_r2i6fj$(this, void 0, _.hu.nevermind.app.App.f_13);
            },
            f_15: function (this$App) {
              return function () {
                _.hu.nevermind.reakt.bootstrap.bsNavItem_8pat5z$(this, _.hu.nevermind.app.App.f_5(this$App), _.hu.nevermind.app.App.f_6);
                _.hu.nevermind.reakt.bootstrap.bsNavItem_8pat5z$(this, _.hu.nevermind.app.App.f_7, _.hu.nevermind.app.App.f_8);
                _.hu.nevermind.reakt.bootstrap.bsNavDropdown_sdj1l$(this, _.hu.nevermind.app.App.f_9, _.hu.nevermind.app.App.f_14);
              };
            },
            f_16: function () {
              this.pullRight = true;
            ...
            f_17: function () {
              this.eventKey = 1;
              this.href = _.Path.root;
            },
            f_18: function () {
              _.com.github.andrewoma.react.text_3pk7xh$(this, 'Link Right');
            },
            f_19: function () {
              this.eventKey = 2;
              this.href = _.hu.nevermind.reakt.bootstrap.nullHref;
            ...
            f_21: function () {
              _.hu.nevermind.reakt.bootstrap.bsNavItem_8pat5z$(this, _.hu.nevermind.app.App.f_17, _.hu.nevermind.app.App.f_18);
            ...
            f_22: function (this$App) {
              return function () {
                _.hu.nevermind.reakt.bootstrap.bsNavbarHeader_hn5u98$(this, void 0, _.hu.nevermind.app.App.f_4);
                _.hu.nevermind.reakt.bootstrap.bsNav_b466ai$(this, void 0, _.hu.nevermind.app.App.f_15(this$App));
                _.hu.nevermind.reakt.bootstrap.bsNav_b466ai$(this, _.hu.nevermind.app.App.f_16, _.hu.nevermind.app.App.f_21);
              };
            },
            f_23: function () {
              this.fluid = true;
            ...
            f_25: function (this$App) {
              return function () {
                if (this$App.state.screen === _.hu.nevermind.app.AppScreen.object.Config) {
                  _.hu.nevermind.app.config.configScreen_sx5o3u$(this);
                }
              };
            },
          ...
          later_o7wwlr$f: function (body, done) {
            return function () {
              body();
              return done();
            };
          },
          later_o7wwlr$: function (assert, body) {
            var done = assert.async();
            window.setTimeout(_.hu.nevermind.app.later_o7wwlr$f(body, done), 1000);
          },
          RoutingTest: Kotlin.createClass(null, function () {
            var test = QUnit.test;
            test('RoutingTests', _.hu.nevermind.app.RoutingTest.RoutingTest$f(this));
            test('ConfigScreenTest', _.hu.nevermind.app.RoutingTest.RoutingTest$f_0);
          }, /** @lends _.hu.nevermind.app.RoutingTest.prototype */ {
            hack: function () {
              Kotlin.modules['stdlib'].kotlin.test.assertTrue_8kj6y5$(true);
            },
            configScreenShouldAppear_za3rmp$: function (assert) {
              window.location.hash = _.Path.root;
              _.hu.nevermind.app.later_o7wwlr$(assert, _.hu.nevermind.app.RoutingTest.configScreenShouldAppear_za3rmp$f(assert));
            }
          }, /** @lends _.hu.nevermind.app.RoutingTest */ {
            RoutingTest$f: function (this$RoutingTest) {
              return function (assert) {
                this$RoutingTest.configScreenShouldAppear_za3rmp$(assert);
              };
            },
            RoutingTest$f_0: function (assert) {
              (new _.hu.nevermind.app.config.ConfigScreenTest()).tests_za3rmp$(assert);
            },
            f: function () {
              return $('#configScreen').size() === 0;
            },
            f_0: function () {
              return Kotlin.equals($('#configScreenNavItem').hasClass('active'), false);
            },
            f_1: function () {
              return $('#configScreen').size() === 1;
            },
            f_2: function () {
              return $('#configScreenNavItem').hasClass('active');
            },
            f_3: function () {
              Kotlin.modules['stdlib'].kotlin.test.assertTrue_c0mt8g$('"config/?editedConfId/" mint\xE1ra meg kell jelennie!', _.hu.nevermind.app.RoutingTest.f_1);
              Kotlin.modules['stdlib'].kotlin.test.assertTrue_c0mt8g$('Ha l\xE1tsz\xF3dik, active-nak kell lennie!', _.hu.nevermind.app.RoutingTest.f_2);
            },
            configScreenShouldAppear_za3rmp$f: function (assert) {
              return function () {
                Kotlin.modules['stdlib'].kotlin.test.assertTrue_c0mt8g$('Alapesetben nem l\xE1tsz\xF3dik a config screen', _.hu.nevermind.app.RoutingTest.f);
                Kotlin.modules['stdlib'].kotlin.test.assertTrue_c0mt8g$('Alapesetben nem l\xE1tsz\xF3dik a config screen, nem lehet active', _.hu.nevermind.app.RoutingTest.f_0);
                window.location.hash = _.Path.config.root;
                _.hu.nevermind.app.later_o7wwlr$(assert, _.hu.nevermind.app.RoutingTest.f_3);
              };
            }
          }),
          getConfigsFromServer_stx1lv$f: function (callback) {
            return function (returnedConfigs) {
              ...
              for (var tmp$2 = 0; tmp$2 !== tmp$1; ++tmp$2) {
                var item = tmp$0[tmp$2];
                destination.add_za3rmp$(new _.hu.nevermind.app.config.Configuration(item.key, item.value));
              }
              callback(Kotlin.copyToArray(destination));
            };
          },
          getConfigsFromServer_stx1lv$: function (callback) {
            _.hu.nevermind.reakt.ajaxGet_435vpa$('/getKeyValues', _.hu.nevermind.app.getConfigsFromServer_stx1lv$f(callback));
          },
          RouterStore$f: function (this$RouterStore) {
            return function (it) {
              this$RouterStore.path = window.location.hash.substring(1);
              this$RouterStore.emitChange();
              if (this$RouterStore.hashChangeEventListenerActive_syi2n6$) {
              }
            };
          },
          match_eoa9s7$f: function (this$RouterStore) {
            return function (pattern) {
              return this$RouterStore.match_7srmwi$(pattern.first, pattern.second);
            };
          },
          config: Kotlin.definePackage(function () {
            this.Actions = Kotlin.createObject(null, function () {
              this.setConfigs = new _.com.github.andrewoma.flux.ActionDef();
              this.modifyConfig = new _.com.github.andrewoma.flux.ActionDef();
            ...
            this.KeyValueStore = Kotlin.createObject(function () {
              ...
              $fun.baseInitializer.call(this);
              this.configs_ouy6xw$ = Kotlin.modules['stdlib'].kotlin.collections.arrayListOf_9mqe4v$([]);
              this.$editingConfig_yjswz1$ = null;
              this.register_80p2z8$(_.hu.nevermind.app.globalDispatcher, _.hu.nevermind.app.config.Actions.setConfigs, _.hu.nevermind.app.config.KeyValueStore$f(this));
              this.register_80p2z8$(_.hu.nevermind.app.globalDispatcher, _.hu.nevermind.app.config.Actions.setEditingKeyValue, _.hu.nevermind.app.config.KeyValueStore$f_0(this));
              this.register_80p2z8$(_.hu.nevermind.app.globalDispatcher, _.hu.nevermind.app.config.Actions.modifyConfig, _.hu.nevermind.app.config.KeyValueStore$f_1(this));
            }, {
              editingConfig: {
                get: function () {
                  return this.$editingConfig_yjswz1$;
                },
                set: function (editingConfig) {
                  this.$editingConfig_yjswz1$ = editingConfig;
                }
              },
              configs: function () {
                return this.configs_ouy6xw$;
              }
            });
          }, /** @lends _.hu.nevermind.app.config */ {
            ModalResult: Kotlin.createEnumClass(function () {
              ...
              return {
                Save: new _.hu.nevermind.app.config.ModalResult(),
                Close: new _.hu.nevermind.app.config.ModalResult()
              };
            }),
            KeyValueScreen: Kotlin.createClass(function () {
              ...
              $fun.baseInitializer.call(this);
            }, /** @lends _.hu.nevermind.app.config.KeyValueScreen.prototype */ {
              componentDidMount: function () {
                _.hu.nevermind.app.config.KeyValueStore.addChangeListener_o7wwlr$(this, _.hu.nevermind.app.config.KeyValueScreen.componentDidMount$f(this));
              },
              componentWillUnmount: function () {
                _.hu.nevermind.app.config.KeyValueStore.removeListener_za3rmp$(this);
              },
              render_sx5o3u$: function ($receiver) {
                var configs = _.hu.nevermind.app.config.KeyValueStore.configs();
                var editingConfig = _.hu.nevermind.app.config.KeyValueStore.editingConfig;
                _.hu.nevermind.reakt.bootstrap.bsGrid_tjxxp7$($receiver, _.hu.nevermind.app.config.KeyValueScreen.render_sx5o3u$f, _.hu.nevermind.app.config.KeyValueScreen.render_sx5o3u$f_0(configs, editingConfig));
              }
            }, /** @lends _.hu.nevermind.app.config.KeyValueScreen */ {
              object_initializer$: function () {
                return Kotlin.createObject(null, function () {
                  this.factory = _.com.github.andrewoma.react.react.createFactory_oqkx6a$(new _.hu.nevermind.app.config.KeyValueScreen());
                });
              },
              ...
              render_sx5o3u$f: function () {
                this.id = 'configScreen';
              },
              f: function () {
                this.md = 10;
              },
              f_0: function (configs) {
                return function () {
                  this.data = Kotlin.copyToArray(configs);
                  this.hover = true;
              ...
              f_2: function (config) {
                return function (it) {
                  _.hu.nevermind.app.config.Actions.setEditingKeyValue.invoke_3vhket$(_.hu.nevermind.app.globalDispatcher, config.key);
                };
              },
              f_3: function (config) {
                return function () {
                  this.bsStyle = _.hu.nevermind.reakt.bootstrap.BsStyle.Primary;
                  this.onClick = _.hu.nevermind.app.config.KeyValueScreen.f_2(config);
                };
              },
              f_4: function () {
              ...
              f_7: function (config) {
                return function () {
                  _.hu.nevermind.reakt.bootstrap.bsButton_j31vv5$(this, _.hu.nevermind.app.config.KeyValueScreen.f_3(config), _.hu.nevermind.app.config.KeyValueScreen.f_4);
                  _.hu.nevermind.reakt.bootstrap.bsButton_j31vv5$(this, _.hu.nevermind.app.config.KeyValueScreen.f_5, _.hu.nevermind.app.config.KeyValueScreen.f_6);
                };
              },
              f_8: function (config) {
                return function () {
                  _.hu.nevermind.reakt.bootstrap.bsButtonGroup_488smo$(this, _.hu.nevermind.app.config.KeyValueScreen.f_1, _.hu.nevermind.app.config.KeyValueScreen.f_7(config));
                };
              },
              f_9: function (cell, config) {
                return _.hu.nevermind.reakt.bootstrap.onTheFly_i41a89$(_.hu.nevermind.app.config.KeyValueScreen.f_8(config));
              },
              f_10: function () {
                this.width = '50';
                this.dataFormat = _.hu.nevermind.app.config.KeyValueScreen.f_9;
              },
              f_11: function () {
                this.isKey = true;
                this.dataField = 'key';
              ...
              f_12: function () {
                _.com.github.andrewoma.react.text_3pk7xh$(this, 'Key HU');
              },
              f_13: function (cell, config) {
              ...
              f_14: function () {
                ...
                this.width = '75';
                this.dataFormat = _.hu.nevermind.app.config.KeyValueScreen.f_13;
              },
              f_15: function () {
                _.com.github.andrewoma.react.text_3pk7xh$(this, '\xC9rt\xE9k');
              },
              f_16: function () {
                _.hu.nevermind.reakt.bootstrap.table.tableHeaderColumn_qi04gk$(this, _.hu.nevermind.app.config.KeyValueScreen.f_10);
                _.hu.nevermind.reakt.bootstrap.table.tableHeaderColumn_qi04gk$(this, _.hu.nevermind.app.config.KeyValueScreen.f_11, _.hu.nevermind.app.config.KeyValueScreen.f_12);
                _.hu.nevermind.reakt.bootstrap.table.tableHeaderColumn_qi04gk$(this, _.hu.nevermind.app.config.KeyValueScreen.f_14, _.hu.nevermind.app.config.KeyValueScreen.f_15);
              },
              f_17: function (configs) {
                return function () {
                  _.hu.nevermind.reakt.bootstrap.table.bootstrapTable_b7jpzj$(this, _.hu.nevermind.app.config.KeyValueScreen.f_0(configs), _.hu.nevermind.app.config.KeyValueScreen.f_16);
                };
              },
              f_18: function (configs) {
                return function () {
                  _.hu.nevermind.reakt.bootstrap.bsCol_zb79fh$(this, _.hu.nevermind.app.config.KeyValueScreen.f, _.hu.nevermind.app.config.KeyValueScreen.f_17(configs));
                };
              },
              closeModal: function (result, entity) {
                if (result === _.hu.nevermind.app.config.ModalResult.object.Save) {
                  _.hu.nevermind.app.config.Actions.modifyConfig.invoke_3vhket$(_.hu.nevermind.app.globalDispatcher, entity != null ? entity : Kotlin.throwNPE());
                }
                 else {
                  _.hu.nevermind.app.config.Actions.setEditingKeyValue.invoke_3vhket$(_.hu.nevermind.app.globalDispatcher, null);
                  window.location.hash = _.Path.config.root;
                }
              },
              render_sx5o3u$f_0: function (configs, editingConfig) {
                return function () {
                  _.hu.nevermind.reakt.bootstrap.bsRow_j32ejn$(this, void 0, _.hu.nevermind.app.config.KeyValueScreen.f_18(configs));
                  if (editingConfig != null) {
                    var closeModal = _.hu.nevermind.app.config.KeyValueScreen.closeModal;
                    _.hu.nevermind.app.config.configEditorDialog_qyb8ej$(this, new _.hu.nevermind.app.config.ConfigEditorDialogProps(editingConfig, closeModal));
                  }
                };
              }
            }),
            ConfigEditorDialogProps: Kotlin.createClass(null, function (editedConf, close) {
              this.editedConf = editedConf;
              this.close = close;
            }, /** @lends _.hu.nevermind.app.config.ConfigEditorDialogProps.prototype */ {
              component1: function () {
                return this.editedConf;
              },
              component2: function () {
                return this.close;
              },
              copy_5q9npg$: function (editedConf, close) {
                return new _.hu.nevermind.app.config.ConfigEditorDialogProps(editedConf === void 0 ? this.editedConf : editedConf, close === void 0 ? this.close : close);
              },
              toString: function () {
                return 'ConfigEditorDialogProps(editedConf=' + Kotlin.toString(this.editedConf) + (', close=' + Kotlin.toString(this.close)) + ')';
              },
              hashCode: function () {
                var result = 0;
                result = result * 31 + Kotlin.hashCode(this.editedConf) | 0;
                result = result * 31 + Kotlin.hashCode(this.close) | 0;
                return result;
              },
              equals_za3rmp$: function (other) {
                return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.editedConf, other.editedConf) && Kotlin.equals(this.close, other.close)))));
              }
            }),
            ConfigEditorDialogState: Kotlin.createClass(null, function (editedConf) {
              this.editedConf = editedConf;
            }, /** @lends _.hu.nevermind.app.config.ConfigEditorDialogState.prototype */ {
              component1: function () {
                return this.editedConf;
              },
              copy_rstz88$: function (editedConf) {
                return new _.hu.nevermind.app.config.ConfigEditorDialogState(editedConf === void 0 ? this.editedConf : editedConf);
              },
              toString: function () {
                return 'ConfigEditorDialogState(editedConf=' + Kotlin.toString(this.editedConf) + ')';
              },
              hashCode: function () {
                var result = 0;
                result = result * 31 + Kotlin.hashCode(this.editedConf) | 0;
              ...
              equals_za3rmp$: function (other) {
                return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && Kotlin.equals(this.editedConf, other.editedConf))));
              }
            }),
            ConfigEditorDialog: Kotlin.createClass(function () {
              return [_.com.github.andrewoma.react.ComponentSpec];
            }, function $fun() {
              $fun.baseInitializer.call(this);
            }, /** @lends _.hu.nevermind.app.config.ConfigEditorDialog.prototype */ {
              initialState: function () {
                return new _.hu.nevermind.app.config.ConfigEditorDialogState(this.props.editedConf);
              },
              updateEntity: function (event, updater) {
                var value = event.currentTarget.value;
                this.state = new _.hu.nevermind.app.config.ConfigEditorDialogState(updater(value));
              },
              render_sx5o3u$: function ($receiver) {
                var conf = this.state.editedConf;
                var errors = Kotlin.modules['stdlib'].kotlin.collections.hashMapOf_eoa9s7$([]);
                this.fillWithErrors(errors);
                _.hu.nevermind.reakt.bootstrap.bsModal_dslzk$($receiver, _.hu.nevermind.app.config.ConfigEditorDialog.render_sx5o3u$f(this), _.hu.nevermind.app.config.ConfigEditorDialog.render_sx5o3u$f_0(conf, this, errors));
              },
              fillWithErrors: function (errors) {
                ...
                var action = _.hu.nevermind.app.config.ConfigEditorDialog.fillWithErrors$f(errors, this);
                var tmp$0, tmp$1, tmp$2;
              ...
              onValidationError_nvfh9u$: function (value, rules, onError) {
                ...
                if (Kotlin.modules['stdlib'].kotlin.collections.isNotEmpty_4m3c68$(errorMessages)) {
                  onError(Kotlin.modules['stdlib'].kotlin.collections.joinToString_sdec0h$(errorMessages, '\n'));
                }
              }
            }, /** @lends _.hu.nevermind.app.config.ConfigEditorDialog */ {
              object_initializer$: function () {
                return Kotlin.createObject(null, function () {
                  this.factory = _.com.github.andrewoma.react.react.createFactory_oqkx6a$(new _.hu.nevermind.app.config.ConfigEditorDialog());
                });
              },
              f: function (this$ConfigEditorDialog) {
                return function () {
                  this$ConfigEditorDialog.props.close(_.hu.nevermind.app.config.ModalResult.object.Close, null);
                };
              },
              render_sx5o3u$f: function (this$ConfigEditorDialog) {
                return function () {
                  this.id = 'configScreen_modal';
                  this.show = true;
                  this.onHide = _.hu.nevermind.app.config.ConfigEditorDialog.f(this$ConfigEditorDialog);
                };
              },
              f_0: function () {
              ...
              f_2: function () {
                _.hu.nevermind.reakt.bootstrap.bsModalTitle_k848lm$(this, void 0, _.hu.nevermind.app.config.ConfigEditorDialog.f_1);
              },
              f_3: function () {
                this.closeButton = true;
              },
              ...
              f_6: function (conf) {
                return function (value) {
                  return conf.copy_puj7f4$(value);
                };
              },
              f_7: function (conf, this$ConfigEditorDialog) {
                return function (it) {
                  this$ConfigEditorDialog.updateEntity(it, _.hu.nevermind.app.config.ConfigEditorDialog.f_6(conf));
                };
              },
              f_8: function (this$) {
              ...
              f_9: function (conf, this$ConfigEditorDialog, errors) {
                return function () {
                  var tmp$0;
                  this.id = 'configScreen_modal_key';
                  this.type = _.hu.nevermind.reakt.bootstrap.InputType.Text;
                  this.label = 'Key';
                  this.defaultValue = conf.key;
                  this.onChange = _.hu.nevermind.app.config.ConfigEditorDialog.f_7(conf, this$ConfigEditorDialog);
                  (tmp$0 = errors.get_za3rmp$('key')) != null ? Kotlin.modules['stdlib'].kotlin.let_7hr6ff$(tmp$0, _.hu.nevermind.app.config.ConfigEditorDialog.f_8(this)) : null;
                };
              },
              f_10: function (conf, this$ConfigEditorDialog, errors) {
                return function () {
                  _.hu.nevermind.reakt.bootstrap.bsInput_nlwo8j$(this, _.hu.nevermind.app.config.ConfigEditorDialog.f_9(conf, this$ConfigEditorDialog, errors));
                };
              },
              f_11: function () {
                this.md = 6;
              ...
              f_12: function (conf) {
                return function (value) {
                  return conf.copy_puj7f4$(void 0, value);
                };
              },
              f_13: function (conf, this$ConfigEditorDialog) {
                return function (it) {
                  this$ConfigEditorDialog.updateEntity(it, _.hu.nevermind.app.config.ConfigEditorDialog.f_12(conf));
                };
              },
              f_14: function (this$) {
                return function (errorMessage) {
              ...
              f_15: function (conf, this$ConfigEditorDialog, errors) {
                return function () {
                  var tmp$0;
                  this.id = 'configScreen_modal_value';
                  this.type = _.hu.nevermind.reakt.bootstrap.InputType.Text;
                  this.label = 'Value';
                  this.defaultValue = conf.value;
                  this.onChange = _.hu.nevermind.app.config.ConfigEditorDialog.f_13(conf, this$ConfigEditorDialog);
                  (tmp$0 = errors.get_za3rmp$('value')) != null ? Kotlin.modules['stdlib'].kotlin.let_7hr6ff$(tmp$0, _.hu.nevermind.app.config.ConfigEditorDialog.f_14(this)) : null;
                };
              },
              f_16: function (conf, this$ConfigEditorDialog, errors) {
                return function () {
                  _.hu.nevermind.reakt.bootstrap.bsInput_nlwo8j$(this, _.hu.nevermind.app.config.ConfigEditorDialog.f_15(conf, this$ConfigEditorDialog, errors));
                };
              },
              f_17: function (conf, this$ConfigEditorDialog, errors) {
                return function () {
                  _.hu.nevermind.reakt.bootstrap.bsCol_zb79fh$(this, _.hu.nevermind.app.config.ConfigEditorDialog.f_5, _.hu.nevermind.app.config.ConfigEditorDialog.f_10(conf, this$ConfigEditorDialog, errors));
                  _.hu.nevermind.reakt.bootstrap.bsCol_zb79fh$(this, _.hu.nevermind.app.config.ConfigEditorDialog.f_11, _.hu.nevermind.app.config.ConfigEditorDialog.f_16(conf, this$ConfigEditorDialog, errors));
                };
              },
              f_18: function (conf, this$ConfigEditorDialog, errors) {
                return function () {
                  _.hu.nevermind.reakt.bootstrap.bsRow_j32ejn$(this, void 0, _.hu.nevermind.app.config.ConfigEditorDialog.f_17(conf, this$ConfigEditorDialog, errors));
                };
              },
              f_19: function (conf, this$ConfigEditorDialog, errors) {
                return function () {
                  _.com.github.andrewoma.react.form_aej7ls$(this, void 0, _.hu.nevermind.app.config.ConfigEditorDialog.f_18(conf, this$ConfigEditorDialog, errors));
                };
              },
              f_20: function (conf, this$ConfigEditorDialog, errors) {
                return function () {
                  _.hu.nevermind.reakt.bootstrap.bsCol_zb79fh$(this, _.hu.nevermind.app.config.ConfigEditorDialog.f_4, _.hu.nevermind.app.config.ConfigEditorDialog.f_19(conf, this$ConfigEditorDialog, errors));
                };
              },
              f_21: function (conf, this$ConfigEditorDialog, errors) {
                return function () {
                  _.hu.nevermind.reakt.bootstrap.bsRow_j32ejn$(this, void 0, _.hu.nevermind.app.config.ConfigEditorDialog.f_20(conf, this$ConfigEditorDialog, errors));
                };
              },
              f_22: function (this$ConfigEditorDialog) {
                return function (it) {
                  this$ConfigEditorDialog.props.close(_.hu.nevermind.app.config.ModalResult.object.Save, this$ConfigEditorDialog.state.editedConf);
                };
              },
              f_23: function (this$ConfigEditorDialog) {
                return function () {
                  this.id = 'configScreen_modal_saveButton';
                  this.bsStyle = _.hu.nevermind.reakt.bootstrap.BsStyle.Success;
                  this.onClick = _.hu.nevermind.app.config.ConfigEditorDialog.f_22(this$ConfigEditorDialog);
                };
              },
              f_24: function () {
                _.com.github.andrewoma.react.text_3pk7xh$(this, 'Ment\xE9s');
              },
              f_25: function (this$ConfigEditorDialog) {
                return function (it) {
                  this$ConfigEditorDialog.props.close(_.hu.nevermind.app.config.ModalResult.object.Close, null);
                };
              },
              f_26: function (this$ConfigEditorDialog) {
                return function () {
                  this.id = 'configScreen_modal_closeButton';
                  this.bsStyle = _.hu.nevermind.reakt.bootstrap.BsStyle.Danger;
                  this.onClick = _.hu.nevermind.app.config.ConfigEditorDialog.f_25(this$ConfigEditorDialog);
                };
              },
              f_27: function () {
                _.com.github.andrewoma.react.text_3pk7xh$(this, 'M\xE9gsem');
              },
              f_28: function (errors, this$ConfigEditorDialog) {
                return function () {
                  if (errors.isEmpty()) {
                    _.hu.nevermind.reakt.bootstrap.bsButton_j31vv5$(this, _.hu.nevermind.app.config.ConfigEditorDialog.f_23(this$ConfigEditorDialog), _.hu.nevermind.app.config.ConfigEditorDialog.f_24);
                  }
                  _.hu.nevermind.reakt.bootstrap.bsButton_j31vv5$(this, _.hu.nevermind.app.config.ConfigEditorDialog.f_26(this$ConfigEditorDialog), _.hu.nevermind.app.config.ConfigEditorDialog.f_27);
                };
              },
              f_29: function (errors, this$ConfigEditorDialog) {
                return function () {
                  _.hu.nevermind.reakt.bootstrap.bsButtonGroup_488smo$(this, void 0, _.hu.nevermind.app.config.ConfigEditorDialog.f_28(errors, this$ConfigEditorDialog));
                };
              },
              render_sx5o3u$f_0: function (conf, this$ConfigEditorDialog, errors) {
                return function () {
                  _.hu.nevermind.reakt.bootstrap.bsModalHeader_bv4bc3$(this, _.hu.nevermind.app.config.ConfigEditorDialog.f_0, _.hu.nevermind.app.config.ConfigEditorDialog.f_2);
                  _.hu.nevermind.reakt.bootstrap.bsModalBody_9g1czy$(this, _.hu.nevermind.app.config.ConfigEditorDialog.f_3, _.hu.nevermind.app.config.ConfigEditorDialog.f_21(conf, this$ConfigEditorDialog, errors));
                  _.hu.nevermind.reakt.bootstrap.bsModalFooter_4ko09h$(this, void 0, _.hu.nevermind.app.config.ConfigEditorDialog.f_29(errors, this$ConfigEditorDialog));
                };
              },
              f_30: function (errors, it) {
                return function (errorMessage) {
                  errors.put_wn2jw4$(it.first, errorMessage);
                };
              },
              fillWithErrors$f: function (errors, this$ConfigEditorDialog) {
                return function (it) {
                  this$ConfigEditorDialog.onValidationError_nvfh9u$(it.second, [new _.hu.nevermind.app.Min(3), new _.hu.nevermind.app.Max(100)], _.hu.nevermind.app.config.ConfigEditorDialog.f_30(errors, it));
                };
              }
            }),
            configEditorDialog_qyb8ej$f: function (props) {
              return function (it) {
                return _.hu.nevermind.app.config.ConfigEditorDialog.object.factory.invoke(new _.com.github.andrewoma.react.Ref(props));
              };
            },
            configEditorDialog_qyb8ej$: function ($receiver, props) {
              return $receiver.constructAndInsert_ad91at$(new _.com.github.andrewoma.react.Component(_.hu.nevermind.app.config.configEditorDialog_qyb8ej$f(props)));
            },
            configScreen_sx5o3u$f: function (it) {
              return _.hu.nevermind.app.config.KeyValueScreen.object.factory.invoke(new _.com.github.andrewoma.react.Ref(null));
            },
            configScreen_sx5o3u$: function ($receiver) {
              return $receiver.constructAndInsert_ad91at$(new _.com.github.andrewoma.react.Component(_.hu.nevermind.app.config.configScreen_sx5o3u$f));
            },
            ConfigScreenTest: Kotlin.createClass(null, function () {
              _.hu.nevermind.app.config.Actions.setConfigs.invoke_3vhket$(_.hu.nevermind.app.globalDispatcher, [new _.hu.nevermind.app.config.Configuration('key', '100')]);
            }, /** @lends _.hu.nevermind.app.config.ConfigScreenTest.prototype */ {
              tests_za3rmp$: function (assert) {
                window.location.hash = _.Path.config.configWithOpenedEditorModal('key');
                _.hu.nevermind.app.later_o7wwlr$(assert, _.hu.nevermind.app.config.ConfigScreenTest.tests_za3rmp$f(assert));
              }
            }, /** @lends _.hu.nevermind.app.config.ConfigScreenTest */ {
              f: function () {
                return $('#configScreen_modal').size() === 1;
              },
              f_0: function () {
                return $('#configScreen_modal_key').size() === 1;
              },
              f_1: function () {
                return $('#configScreen_modal_value').size() === 1;
              },
              f_2: function () {
                return Kotlin.equals($('#configScreen_modal_key').val(), 'key');
              },
              f_3: function () {
                return Kotlin.equals($('#configScreen_modal_value').val(), '100');
              },
              f_4: function () {
                Kotlin.modules['stdlib'].kotlin.test.assertEquals_8vv676$('config/', _.hu.nevermind.app.RouterStore.path);
              },
              tests_za3rmp$f: function (assert) {
                return function () {
                  Kotlin.modules['stdlib'].kotlin.test.assertTrue_c0mt8g$('"config/?editedId/" mint\xE1ra meg kell jelennie a Modalnak!', _.hu.nevermind.app.config.ConfigScreenTest.f);
                  Kotlin.modules['stdlib'].kotlin.test.assertTrue_c0mt8g$('key', _.hu.nevermind.app.config.ConfigScreenTest.f_0);
                  Kotlin.modules['stdlib'].kotlin.test.assertTrue_c0mt8g$('value', _.hu.nevermind.app.config.ConfigScreenTest.f_1);
                  Kotlin.modules['stdlib'].kotlin.test.assertTrue_c0mt8g$('key value', _.hu.nevermind.app.config.ConfigScreenTest.f_2);
                  Kotlin.modules['stdlib'].kotlin.test.assertTrue_c0mt8g$('value value', _.hu.nevermind.app.config.ConfigScreenTest.f_3);
                  Kotlin.modules['stdlib'].kotlin.test.assertEquals_8vv676$('config/key/', _.hu.nevermind.app.RouterStore.path);
                  React.addons.TestUtils.Simulate.click($('#configScreen_modal_closeButton').get(0));
                  _.hu.nevermind.app.later_o7wwlr$(assert, _.hu.nevermind.app.config.ConfigScreenTest.f_4);
                };
              }
            }),
            Configuration: Kotlin.createClass(null, function (key, value) {
              this.key = key;
              this.value = value;
            }, /** @lends _.hu.nevermind.app.config.Configuration.prototype */ {
              component1: function () {
                return this.key;
              },
              component2: function () {
              ...
              copy_puj7f4$: function (key, value) {
                return new _.hu.nevermind.app.config.Configuration(key === void 0 ? this.key : key, value === void 0 ? this.value : value);
              },
              toString: function () {
                return 'Configuration(key=' + Kotlin.toString(this.key) + (', value=' + Kotlin.toString(this.value)) + ')';
              },
              hashCode: function () {
                var result = 0;
            ...
            KeyValueStore$f: function (this$KeyValueStore) {
              return function (newConfigs) {
                this$KeyValueStore.configs_ouy6xw$ = Kotlin.modules['stdlib'].kotlin.collections.toArrayList_eg9ybj$(newConfigs);
            ...
            KeyValueStore$f_0: function (this$KeyValueStore) {
              return function (key) {
                var newConf;
                var $receiver = _.hu.nevermind.app.config.KeyValueStore.configs();
                firstOrNull_azvtw4$break: {
                  var tmp$0;
                  tmp$0 = $receiver.iterator();
                  while (tmp$0.hasNext()) {
                ...
                this$KeyValueStore.editingConfig = newConf;
                this$KeyValueStore.emitChange();
              };
            },
            KeyValueStore$f_1: function (this$KeyValueStore) {
              return function (modifiedConfig) {
                ...
                indexOfFirst_rw062o$break: {
                  ...
                  tmp$0 = Kotlin.modules['stdlib'].kotlin.collections.get_indices_4m3c68$(this$KeyValueStore.configs_ouy6xw$), tmp$1 = tmp$0.start, tmp$2 = tmp$0.end, tmp$3 = tmp$0.increment;
                  for (var index_0 = tmp$1; index_0 <= tmp$2; index_0 += tmp$3) {
                    var it = this$KeyValueStore.configs_ouy6xw$.get_za3lpa$(index_0);
                    if (Kotlin.equals(it.key, modifiedConfig.key)) {
                      index = index_0;
                ...
                this$KeyValueStore.configs_ouy6xw$.set_vux3hl$(index, modifiedConfig);
                this$KeyValueStore.emitChange();
              };
            }
          })
    ...
    configWithOpenedEditorModal$f: function (this$config) {
      return function (confId) {
        return this$config.root + confId + '/';
      };
    },
    config: function () {
      return Kotlin.createObject(null, function () {
        this.root = '#config/';
        this.configWithOpenedEditorModal = _.configWithOpenedEditorModal$f(this);
      });
    }
  });
